...
var ManagerComponent = /** @class */ (function () {
    function ManagerComponent(authServiec, router, toasterService, location) {
    ...
    ManagerComponent.prototype.deleteManager = function (manager) {
        var _this = this;
        ...
        if (r == true) {
            ...
            this.authServiec.deleteUser(manager)
                ...
                _this.toasterService.Info("Successfully Deleted!!");
            });
        }
        else {
...
var PharmasistDashboardComponent = /** @class */ (function () {
    ...
    PharmasistDashboardComponent.prototype.medicineDelete = function (medicine) {
        var _this = this;
        var r = confirm("Are you sure!");
        if (r == true) {
...
var PharmasistComponent = /** @class */ (function () {
    ...
    PharmasistComponent.prototype.deleteManager = function (manager) {
        var _this = this;
        var r = confirm("Are you sure!");
        if (r == true) {
            this.manager.splice(this.manager.indexOf(manager), 1);
...
var SalesmanComponent = /** @class */ (function () {
    ...
    SalesmanComponent.prototype.deleteManager = function (manager) {
        var _this = this;
        var r = confirm("Are you sure!");
        if (r == true) {
            this.manager.splice(this.manager.indexOf(manager), 1);
...
module.exports = "<div  class=\"bg\">\n  <div *ngIf=\"user\" class=\"container\">\n\n    <h1 style=\"margin-top: 1%;text-align: center; font-family: 'Times New Roman'; color: blue\">Update {{user.category}}</h1>\n\n    <div class=\"row\" style=\"margin-top:20px\">\n      <div style=\"margin-left: 15%\" class=\"col-xs-8 col-sm-8 col-md-8 \">\n        <form *ngIf=\"user\" (submit)=\"onUpdate(user)\" role=\"form\">\n\n          <div class=\"form-group\">\n            <label>First Name</label>\n            <input type=\"text\" [(ngModel)]=\"user.firstName\" name=\"first_name\" class=\"form-control input-sm\" placeholder=\"First Name\">\n          </div>\n\n          <div class=\"form-group\">\n            <label>Last Name</label>\n            <input type=\"email\" [(ngModel)]=\"user.lastName\" name=\"last_name\"  class=\"form-control input-sm\" placeholder=\"Email Address\">\n          </div>\n\n          <div class=\"form-group\">\n            <label>Staff Id</label>\n            <input type=\"email\" [(ngModel)]=\"user.staffId\" name=\"staffId\"  class=\"form-control input-sm\" placeholder=\"Email Address\">\n          </div>\n\n          <div class=\"form-group\">\n            <label>Address</label>\n            <input type=\"email\" [(ngModel)]=\"user.address\" name=\"address\"  class=\"form-control input-sm\" placeholder=\"Email Address\">\n          </div>\n\n          <div class=\"form-group\">\n            <label>Phone</label>\n            <input type=\"email\" [(ngModel)]=\"user.phone\" name=\"phone\"  class=\"form-control input-sm\" placeholder=\"Email Address\">\n          </div>\n\n          <div class=\"form-group\">\n            <label>Email</label>\n            <input type=\"email\" [(ngModel)]=\"user.email\" name=\"email\"  class=\"form-control input-sm\" placeholder=\"Email Address\">\n          </div>\n\n          <div class=\"form-group\">\n            <label>User Name</label>\n            <input type=\"email\" [(ngModel)]=\"user.username\" name=\"username\"  class=\"form-control input-sm\" placeholder=\"Email Address\">\n          </div>\n\n\n          <input type=\"submit\" value=\"Update\" class=\"btn btn-info btn-block\">\n\n        </form>\n      </div>\n    </div>\n\n\n\n  </div>\n\n  <div style=\"height:20px\">\n\n  </div>\n\n</div>\n\n"
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.deleteUser = function (user) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["Headers"]();
        headers.append('Content-type', 'application/json');
        return this.http.delete(__WEBPACK_IMPORTED_MODULE_4__environments_environment__["a" /* environment */].baseUrl + "/user/" + user._id, { headers: headers })
            .map(function (res) { return res.json(); });
    };
...
var MedicineService = /** @class */ (function () {
    ...
    MedicineService.prototype.deleteMedicine = function (id) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["Headers"]();
        headers.append('Content-type', 'application/json');
        return this.http.delete(__WEBPACK_IMPORTED_MODULE_3__environments_environment__["a" /* environment */].baseUrl + "/medicine/" + id, { headers: headers })
            .map(function (res) { return res.json(); });
    };
